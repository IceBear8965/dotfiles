...
-- Neo Tree
vim.keymap.set("n", "<leader>t", ":Neotree left reveal<CR>")
vim.keymap.set("n", "<leader>tt", ":Neotree left reveal toggle<CR>")
...
vim.keymap.set("n", "<leader>do", function()
    dap.step_over()
end, { noremap = true, silent = true, desc = "[D]ebug [N]ext" })
